...
namespace WindowsFormsApplication1.BUS
{
    public class BUS_Nguoidung
    {
        ...
        internal void upDateMyExp(Nguoidung nguoidung, double? eXPERIENCE)
        {
            dal_nguoidung.upDateExpForUser(nguoidung, eXPERIENCE);
        }

        internal bool checkDuplicate(Nguoidung nguoidung)
        {
            return dal_nguoidung.checkDuplicate(nguoidung);
        }
    }
}
